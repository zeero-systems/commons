...
export default (providerName?: ConstructorType<any> | KeyType, scope: ScopeEnum = ScopeEnum.Transient): DecoratorFunctionType => Decorator.apply(Consume, { scope, providerName });
