...
export class GreaterThanEqualValidation implements AnnotationInterface, ValidationInterface {
  name: string = 'GreaterThanEqual'
...
export default GreaterThanEqualValidation
